        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfAquire = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Progress = table.Column<double>(nullable: false),
                    StatusId = table.Column<int>(nullable: false),
                    AssignorId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeesProjectsRoles", x => new { x.ProjectId, x.EmployeeId, x.ProjectPositionId });
                    table.ForeignKey(
                        name: "FK_EmployeesProjectsRoles_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeesProjectsRoles_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentsEmployees", x => new { x.AssignmentId, x.AssistantId });
                    table.ForeignKey(
                        name: "FK_AssignmentsEmployees_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentsEmployees_AspNetUsers_AssistantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingMinutes = table.Column<int>(nullable: false),
                    EmployeeId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LeavingReasonId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentsEmployees_AssistantId",
                table: "AssignmentsEmployees",
                column: "AssistantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeesProjectsRoles_EmployeeId",
